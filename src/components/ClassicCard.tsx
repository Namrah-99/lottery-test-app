...
function ClassicCard({ data }: any) {
  ...
  return (
    <div className="space-y-4 bg-blue-100 rounded-md">
      ...
      <div className="p-3 flex justify-between items-center bg-blue-800 text-slate-50">
        ...
        <button
          className="w-1/6 px-3 py-2 rounded-md font-semibold bg-slate-50 text-blue-800"
